...
export function LicenseDialog() {
  ...
  return <Dialog.Root>
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed left-1/2 top-1/2 z-50 max-h-[90vh] w-[min(94vw,42rem)] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-xl border bg-surface p-5 shadow-2xl focus:outline-none">
